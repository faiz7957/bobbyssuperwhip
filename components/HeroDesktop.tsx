  ...
  return (
    <section className="relative isolate hidden min-h-[100svh] overflow-hidden md:block">
      ...
      <div className="relative z-10 flex min-h-[100svh] max-w-7xl items-center pl-5 pr-10 py-24">
        <div className="w-full max-w-sm rounded-3xl border border-white/10 bg-slate-900/10 p-8 shadow-lg backdrop-blur-sm">
          ...
          <div className="mt-8 flex flex-col gap-4 sm:flex-row">
            <Link
              href="/book"
              className="rounded-xl bg-yellow-400 px-8 py-4 text-center font-bold text-slate-900"
            >
              Book an Event
            </Link>
            ...
            <a
              href="/#treats"
              className="rounded-xl border-2 border-white px-8 py-4 text-center font-semibold text-white"
            >
              View Our Treats
            </a>
          </div>
